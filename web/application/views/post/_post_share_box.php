...
<ul class="share-box">
    ...
    <li class="share-li-lg">
        <a href="javascript:void(0)"
           onclick="window.open('https://twitter.com/share?url=<?php echo generate_post_url($post); ?>&amp;text=<?php echo html_escape($post->title); ?>', 'Share This Post', 'width=640,height=450');return false"
    ...
    <li>
        <a href="javascript:void(0)"
           onclick="window.open('https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo generate_post_url($post); ?>', 'Share This Post', 'width=640,height=450');return false"
    ...
    <li>
        <a href="javascript:void(0)"
           onclick="window.open('https://pinterest.com/pin/create/button/?url=<?php echo generate_post_url($post); ?>&amp;media=<?php echo base_url() . html_escape($post->image_default); ?>', 'Share This Post', 'width=640,height=450');return false"
    ...
    <li>
        <a href="javascript:void(0)"
           onclick="window.open('https://www.tumblr.com/share/link?url=<?php echo generate_post_url($post); ?>&amp;title=<?php echo html_escape($post->title); ?>', 'Share This Post', 'width=640,height=450');return false"
