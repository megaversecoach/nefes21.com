...
<strong>Bildirim !</strong><br>
<strong>Şu Anda</strong>  <strong><?php echo $sayi = rand(10,150); ?></strong> kişi bu sayfayı inceliyor.
</div>
...
var latest = document.getElementsByClassName("latest-sales");
var i;
for (i = 0; i < latest.length; i++) {
await sleep(2000);
latest[i].classList.add('active');
await sleep(8000);
latest[i].classList.remove('active');
await sleep(2000);
}
}
