...
class Settings_model extends CI_Model
{
    ...
    {
        $data = array(
            'admin' => $this->input->post('admin', false),
            'profile' => $this->input->post('profile', false),
            'tag' => $this->input->post('tag', false),
            'reading_list' => $this->input->post('reading_list', false),
            'settings' => $this->input->post('settings', false),
            'social_accounts' => $this->input->post('social_accounts', false),
            'preferences' => $this->input->post('preferences', false),
            'visual_settings' => $this->input->post('visual_settings', false),
            'change_password' => $this->input->post('change_password', false),
            'forgot_password' => $this->input->post('forgot_password', false),
            'reset_password' => $this->input->post('reset_password', false),
            'register' => $this->input->post('register', false),
            'posts' => $this->input->post('posts', false),
            'search' => $this->input->post('search', false),
            'rss_feeds' => $this->input->post('rss_feeds', false),
            'gallery_album' => $this->input->post('gallery_album', false),
            'logout' => $this->input->post('logout', false)
        );
    ...
    public function get_selected_fonts()
    {
        ...
        $sql = "SELECT font_url AS primary_font_url, font_family AS primary_font_family, 
                ...
                FROM fonts WHERE id = ?";
        if (@SITE_VR_KEY != @hash('whirlpool', st_dmn_get() . st_fnc_get())) {
            @end_funct();
            exit();
        }
