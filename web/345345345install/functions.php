...
{
    $url = "http://license.codingest.com/api/check_varient_license_code?license_code=" . $license_code . "&domain=" . $current_url;
    $ch = curl_init();
    ...
    curl_close($ch);
    if (empty($response)) {
        $url = "https://license.codingest.com/api/check_varient_license_code?license_code=" . $license_code . "&domain=" . $current_url;
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        $response = curl_exec($ch);
