...
App.SubmissionView = Backbone.View.extend({
    ...
    render: function(){
        ...
        var that = this;
        that.$('div[data-key*="selectlist"], div[data-key*="checkbox"], div[data-key*="matrix"]')
...
App.DetailView = Backbone.View.extend({
    ...
    render: function(){
        if (this.modelExists) {
            ...
            // If this field is a checkbox or select list or matrix, add space after a comma
            var that = this;
            that.$('.table-detail').find('td[data-key*="selectlist"], td[data-key*="checkbox"], td[data-key*="matrix"]')
                .each(function(index, value){
                    that.$(value).text(function(i, val) {
                        return val.replace(/,/g, ", ");
                    });
