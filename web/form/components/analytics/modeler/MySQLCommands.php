...
class MySQLCommands
{
    ...
    protected $mariadbIsBelow102 = false;
    ...
    public function __construct()
    {
        ...
        $this->mysqlIsBelow57 = version_compare($this->db->getServerVersion(),5.7) === -1;
        $this->mariadbIsBelow102 = version_compare($this->db->getServerVersion(),10.2) === -1;
    }
    ...
    protected function savePerformanceByDay()
    {
        ...
        if ($this->mysqlIsBelow57 || ($this->isMariaDB && $this->mariadbIsBelow102)) {
            $sql = "
        INSERT INTO {{%stats_performance}} (day, app_id, users, fills, conversions, conversionTime)
            SELECT su.day,
                su.app_id,
