<nav aria-label="breadcrumb">
    ...
    <li class="breadcrumb-item active">Servers _List</li>
    </ol>
</nav>
<!-- Content here -->
    <div class="col">
    <div class="card">
    <div class="card-header mb-4"><span class="badge bg-primary p-2">Add/Edit Server</span></div>
    <div class="card-body">
    <?=$this->displayAlerts()?>
    ...
    <input type="text" id="server-name" class="form-control"  name="name" placeholder="name servers">
    </div>
    </div>
    <div class="col">
    <div class="form-group mb-3">
    <label class="form-label">Doamin</label>
    <input type="url" id="server-domain" class="form-control" name="domain" placeholder="http://servers.subdomain.com" required>
    </div>
    ...
    <div class="col">
    <div class="card">
    <div class="card-header mb-4"><span class="badge bg-primary p-2">Servers List</span></div>
    <div class="card-body">
