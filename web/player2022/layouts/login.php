...
<body>
    ...
    <span class="app-brand-text demo fw-bolder text-capitalize " style="color: #414EDB">MXPlayer</span>
    </a>
    </div>
    <h4 class="mb-2 text-center mb-4">Welcome To MXPlayer</h4>
    ...
    &#169; <?php echo date("Y"); ?> Made With By <i class="bx bx-heart mb-1"></i> <a href="https://codeside.biz.id" target="_blank">Codeside ID</a>
