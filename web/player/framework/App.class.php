...

{
...

    {
        ...
        $this->setTitle('Dashboard | MXPlayer');
...

    {
        ...
        $this->setTitle('Admin Profile | ' . APP_NAME . ' MXPlayer');
...

        {
...

            {
                ...
                case 'general':
                    ...
                    $this->setTitle('General Settings | ' . APP_NAME . ' MXPlayer');
                ...
                case 'backup':
                    ...
                    $this->setTitle('Backup Movie | ' . APP_NAME . ' MXPlayer');
                ...
                case 'proxy':
                    ...
                    $this->setTitle('Proxy Settings | ' . APP_NAME . ' MXPlayer');
                ...
                case 'gauth':
                    ...
                    $this->setTitle('G-OAuth Settings | ' . APP_NAME . ' MXPlayer');
...

    {
        ...
        $this->setTitle('Ads Manager | ' . APP_NAME . ' MXPlayer');
...

    {
        ...
        $this->setTitle('Servers | ' . APP_NAME . ' MXPlayer');
...

    {
...

                {
...

                    {
...

                        {
                            ...
                            $pData = ['sources' => $sources, 'subs' => Helper::cleanSub($file['subtitles']) , 'title' => $file['title'],  'main_link' => $file['main_link'], 'poster' => Helper::getBanner($file['preview_img']) , 'id' => $this->id, 'type' => $this->videoType, 'player' => $player];
                        }
...

            {
...

                {
                    ...
                    case 'edit':
                        ...
                        $this->setTitle('Add/Edit Link | ' . APP_NAME . ' MXPlayer');
                    ...
                    case 'all':
                        ...
                        $this->setTitle('Movie All | ' . APP_NAME . ' MXPlayer');
...

        {
            ...
            $this->setTitle('Bulk Import | ' . APP_NAME . ' MXPlayer');
