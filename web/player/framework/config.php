...
define('DB_USER', 'nefes03_playeryandex'); // Your mySQL Databse username
define('DB_PASS', 'Y8omMsH8L'); // Your mySQL Databse Password
define('DB_NAME', 'nefes03_playeryandex'); // The database where you have dumped the included sql file
 ...
 * default : ''
 * example : domain.com/mxplayer
 * define('PROOT', '/mxplayer');
 */
define('PROOT', '');
...
{
    include (ROOT . '/framework/core.php');
}
